...
def generate_launch_description():
    ...
    start_target_input = LaunchConfiguration("start_target_input")
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("start_target_input", default_value="false"),
        DeclareLaunchArgument(
            "start_rviz",
            default_value="true",
        ...
        Node(
            ...
            parameters=[integration_config],
            output="screen",
        ),
        Node(
            package="bluerov_integration",
            executable="target_position_input_node",
            name="target_position_input_node",
            output="screen",
            condition=IfCondition(start_target_input),
        ),
        Node(
            package="rviz2",
            executable="rviz2",
